...
const Impressum = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      <Helmet>
        <title>Impressum | CashCar Hannover</title>
        <meta name="description" content="Impressum von CashCar Hannover. Angaben gemäß § 5 TMG. Kontaktinformationen und rechtliche Hinweise." />
        <link rel="canonical" href="https://www.cashcarhannover.de/impressum" />
      </Helmet>
